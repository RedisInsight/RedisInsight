...
export default {
  ...
  cloud: {
    ...
    apiToken: process.env.RI_CLOUD_API_TOKEN || 'bmu7yk54bd6a263sfwk3ytu4wc28te4acn9hdnyk35dbk8b2etxmaj8ryuwq57nn',
    ...
    idp: {
      google: {
        authorizeUrl: process.env.RI_CLOUD_IDP_GOOGLE_AUTHORIZE_URL || process.env.RI_CLOUD_IDP_AUTHORIZE_URL || 'oauth2/default/v1/authorize',
        tokenUrl: process.env.RI_CLOUD_IDP_GOOGLE_TOKEN_URL || process.env.RI_CLOUD_IDP_TOKEN_URL || 'oauth2/default/v1/token',
        issuer: process.env.RI_CLOUD_IDP_GOOGLE_ISSUER || process.env.RI_CLOUD_IDP_ISSUER || 'https://auth.qa.redislabs.com',
        clientId: process.env.RI_CLOUD_IDP_GOOGLE_CLIENT_ID || process.env.RI_CLOUD_IDP_CLIENT_ID || '0oa7ku3x9aALuh3uK1d7',
        redirectUri: process.env.RI_CLOUD_IDP_GOOGLE_REDIRECT_URI || process.env.RI_CLOUD_IDP_REDIRECT_URI || 'https://auth.redisinsight.redis.com/callback.html',
        idp: process.env.RI_CLOUD_IDP_GOOGLE_ID || '0oa8in2sir3kD2jdN1d7',
      },
      github: {
        authorizeUrl: process.env.RI_CLOUD_IDP_GH_AUTHORIZE_URL || process.env.RI_CLOUD_IDP_AUTHORIZE_URL || 'oauth2/default/v1/authorize',
        tokenUrl: process.env.RI_CLOUD_IDP_GH_TOKEN_URL || process.env.RI_CLOUD_IDP_TOKEN_URL || 'oauth2/default/v1/token',
        issuer: process.env.RI_CLOUD_IDP_GH_ISSUER || process.env.RI_CLOUD_IDP_ISSUER || 'https://auth.qa.redislabs.com',
        clientId: process.env.RI_CLOUD_IDP_GH_CLIENT_ID || process.env.RI_CLOUD_IDP_CLIENT_ID || '0oa7ku3x9aALuh3uK1d7',
        redirectUri: process.env.RI_CLOUD_IDP_GH_REDIRECT_URI || process.env.RI_CLOUD_IDP_REDIRECT_URI || 'https://auth.redisinsight.redis.com/callback.html',

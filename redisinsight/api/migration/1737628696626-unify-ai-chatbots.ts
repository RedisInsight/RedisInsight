...
export class UnifyAiChatbots1737628696626 implements MigrationInterface {
    name = 'UnifyAiChatbots1737628696626'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "ai_message" ("id" varchar PRIMARY KEY NOT NULL, "databaseId" varchar, "accountId" varchar NOT NULL, "conversationId" varchar, "type" varchar NOT NULL, "content" blob NOT NULL, "tool" varchar NOT NULL DEFAULT ('General'), "steps" blob, "createdAt" datetime NOT NULL DEFAULT (datetime('now')), "encryption" varchar)`);

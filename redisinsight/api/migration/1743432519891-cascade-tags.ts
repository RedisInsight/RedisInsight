...
export class CascadeTags1743432519891 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "temporary_database_tag" ("databaseId" varchar NOT NULL, "tagId" varchar NOT NULL, CONSTRAINT "FK_c1958471fa6e48e80e0dc4b27a5" FOREIGN KEY ("databaseId") REFERENCES "database_instance" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("databaseId", "tagId"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "database_tag" ("databaseId" varchar NOT NULL, "tagId" varchar NOT NULL, CONSTRAINT "FK_c1958471fa6e48e80e0dc4b27a5" FOREIGN KEY ("databaseId") REFERENCES "database_instance" ("id") ON DELETE CASCADE ON UPDATE CASCADE, PRIMARY KEY ("databaseId", "tagId"))`);

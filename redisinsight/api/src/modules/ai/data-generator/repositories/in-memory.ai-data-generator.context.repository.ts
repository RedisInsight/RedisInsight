...
@Injectable()
export class InMemoryAiDataGeneratorContextRepository extends AiDataGeneratorContextRepository {
  ...
  async getFullDbContext(
    ...
    const chatId = InMemoryAiDataGeneratorContextRepository.getChatId(
      databaseId,
      accountId,
    );

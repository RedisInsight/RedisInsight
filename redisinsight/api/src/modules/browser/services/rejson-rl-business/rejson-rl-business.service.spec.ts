...
describe('JsonBusinessService', () => {
  let service: RejsonRlBusinessService;
  let browserTool;
  ...
  beforeEach(async () => {
    ...
    service = module.get<RejsonRlBusinessService>(RejsonRlBusinessService);
  ...
  describe('getJson', () => {
    ...
    describe('full json download', () => {
      ...
      it('should throw BadRequest error when no key found in the database', async () => {
        ...
        try {
          await service.getJson(mockClientOptions, {
            keyName: testKey,
            path: testPath,
          });
          fail();
  ...
  describe('create', () => {
    ...
    it('should throw Conflict error when key is already in the database', async () => {
      ...
      try {
        await service.create(mockClientOptions, {
          keyName: testKey,
    ...
    it('should silently handle key expire error and log it', async () => {
      ...
      when(browserTool.execCommand)
        .calledWith(mockClientOptions, BrowserToolRejsonRlCommands.JsonSet, [
          testKey,
          testPath,
  ...
  describe('jsonSet', () => {
    ...
    it('should throw NotFound error when key does not exists for jsonSet', async () => {
      ...
      try {
        await service.jsonSet(mockClientOptions, {
          keyName: testKey,
          path: testPath,
          data: testSerializedObject,
        });
  ...
  describe('arrAppend', () => {
    ...
    it('should throw NotFound error when key does not exists', async () => {
      ...
      try {
        await service.arrAppend(mockClientOptions, {
          keyName: testKey,
          path: testPath,
          data: [testSerializedObject],
        });
  ...
  describe('remove', () => {
    ...
    it('should throw NotFound error when key does not exists', async () => {
      ...
      try {
        await service.remove(mockClientOptions, {
          keyName: testKey,
          path: testPath,
        });
        fail();

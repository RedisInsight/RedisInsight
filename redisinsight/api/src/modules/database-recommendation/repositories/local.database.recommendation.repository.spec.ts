...
// describe('DatabaseRecommendationRepository', () => {
...
//       expect(await service.create(mockDatabaseRecommendation)).toEqual(mockDatabaseRecommendation);
//     });
//   });
...
//       await service.update(mockDatabaseRecommendation.id, { vote });
...
//       await service.update(mockDatabaseRecommendation.id, { hide });
//       expect(repository.update).toBeCalledWith(
//         mockDatabaseRecommendationEntity.id,

...
import {
  ...
  mockDatabaseEntity, mockSentinelDatabaseWithTlsAuth,
  MockType
} from 'src/__mocks__';
...
describe('RedisService', () => {
  ...
  describe('connectToDatabaseInstance', () => {
    ...
    it('should create cluster client', async () => {
      ...
      const { nodes, connectionType, ...options } = mockClusterDatabaseWithTlsAuth;
    ...
    it('should create sentinel client', async () => {
      ...
      const { nodes, connectionType, ...options } = dto;

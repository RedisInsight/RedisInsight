...
describe('AutodiscoveryAnalyticsService', () => {
  let service: AutodiscoveryAnalyticsService;
  let sendEventMethod;
  ...
  beforeEach(async () => {
    ...
    service = await module.get<AutodiscoveryAnalyticsService>(AutodiscoveryAnalyticsService);
    sendEventMethod = jest.spyOn<AutodiscoveryAnalyticsService, any>(
      service,
      'sendEvent',
    );
    sendFailedEventMethod = jest.spyOn<AutodiscoveryAnalyticsService, any>(
      service,
      'sendFailedEvent',
    );
  });

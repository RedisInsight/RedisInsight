...
@Injectable()
export class RedisCloudBusinessService {
  ...
  async getSubscriptions(
    ...
    try {
      ...
      this.autodiscoveryAnalyticsService.sendGetRECloudSubsSucceedEvent(result);
      return result;
    } catch (error) {
      const exception = this.getApiError(error, 'Failed to get RE cloud subscriptions');
      this.autodiscoveryAnalyticsService.sendGetRECloudSubsFailedEvent(exception);
      throw exception;
    }
  }
  ...
  async getDatabasesInMultipleSubscriptions(
    ...
    try {
      ...
      this.autodiscoveryAnalyticsService.sendGetRECloudDbsSucceedEvent(result);
      return result;
    } catch (exception) {
      this.autodiscoveryAnalyticsService.sendGetRECloudDbsFailedEvent(exception);
      throw exception;
    }
  }

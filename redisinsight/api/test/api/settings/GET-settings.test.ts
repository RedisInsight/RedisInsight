...
import { applyEulaAgreement, initSettings, resetSettings } from '../../helpers/local-db';
...
describe('GET /settings', () => {
  ...
  [
    ...
    },
    {
      ...
      checkFn: ({ body }) => {
        expect(body).to.have.nested.property("agreements.eula").that.deep.equals(true);
        expect(body).to.have.nested.property("agreements.encryption").that.deep.equals(true);
      },

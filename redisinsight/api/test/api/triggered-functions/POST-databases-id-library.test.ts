...
const endpoint = (instanceId = constants.TEST_INSTANCE_ID) =>
  request(server).post(`/${constants.API.DATABASES}/${instanceId}/triggered-functions/library`);
      ...
      [
        {
          ...
          before: async () => {
            ...
            try {
              await rte.data.sendCommand('TFUNCTION', ['DELETE', constants.TEST_TRIGGERED_FUNCTIONS_LIBRARY_NAME]);
            } catch (err) {
              // ignore
            }

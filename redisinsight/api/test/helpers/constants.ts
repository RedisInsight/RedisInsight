...
export const constants = {
  ...
  TEST_RECOMMENDATION_NAME_2: RECOMMENDATION_NAMES.SEARCH_STRING,
  TEST_RECOMMENDATION_NAME_3: RECOMMENDATION_NAMES.SEARCH_STRING,
  ...
  TEST_SEARCH_STRING_RECOMMENDATION: {

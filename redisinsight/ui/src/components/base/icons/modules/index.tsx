...
export const RediStackDarkLogoIcon = (props: IconProps) => (
  <Icon icon={RediStackDarkLogoSvg} {...props} isSvg />
)

export const RediStackDarkMinIcon = (props: IconProps) => (
  <Icon icon={RediStackDarkMinSvg} {...props} isSvg />
)

export const RediStackLightLogoIcon = (props: IconProps) => (
  <Icon icon={RediStackLightLogoSvg} {...props} isSvg />
)

export const RediStackLightMinIcon = (props: IconProps) => (
  <Icon icon={RediStackLightMinLight} {...props} isSvg />
)

export const RedisTimeSeriesDarkIcon = (props: IconProps) => (
  <Icon icon={RedisTimeSeriesDark} {...props} isSvg />
)
...
export const UnknownLightIcon = (props: IconProps) => (
  <Icon icon={UnknownLight} {...props} isSvg />
)

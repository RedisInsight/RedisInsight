...
describe('CliSearchOutput', () => {
  it('should render', () => {
    expect(render(<CliSearchOutput searchedCommands={[]} />)).toBeTruthy()
  })

  it('should render no results', () => {
    render(<CliSearchOutput searchedCommands={[]} />)
  ...
  it('should render searched commands results', () => {
    ...
    render(<CliSearchOutput searchedCommands={searchedCommands} />)

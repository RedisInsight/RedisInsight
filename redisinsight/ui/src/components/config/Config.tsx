...
import { fetchContentAction as fetchCreateDatabaseContentAction } from 'uiSrc/slices/content/content-create-database'
...
const Config = () => {
  ...
  useEffect(() => {
    ...
    dispatch(fetchCreateDatabaseContentAction())

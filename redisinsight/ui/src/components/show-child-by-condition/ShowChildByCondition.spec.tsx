...
const A = ({ children }: { children: React.ReactElement }) => (
  <div data-testid="a-wrapper">
    <div data-testid="a-inner">{children}</div>
  </div>
)
...
describe('ShowChildByCondition', () => {
  ...
  it('should render only B', () => {
    render(
      <ShowChildByCondition isShow={false}>
        <A>
          <B />
        </A>
      </ShowChildByCondition>,

...
const DataGeneratorChatHeader = (props: Props) => {
          ...
          <EuiPopover
            ...
            button={
              <EuiButtonEmpty
                ...
                data-testid="ai-data-generator-tutorial-btn"
              />
            }
          >
            <>
              ...
              <EuiButton
                ...
                data-testid="ai-data-generator-open-tutorials"
              >
                Open tutorials
              </EuiButton>
            </>
        ...
        <RestartChat
          button={
            <EuiButtonEmpty
              ...
              data-testid="ai-data-generator-restart-session-btn"
            />
          }
          onConfirm={onRestart}
        />

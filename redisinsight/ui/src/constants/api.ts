...
const SCAN_COUNT_DEFAULT_ENV = ENV_VARS.SCAN_COUNT_DEFAULT || '500'
const PIPELINE_COUNT_DEFAULT_ENV = ENV_VARS.PIPELINE_COUNT_DEFAULT || '5'
const SCAN_TREE_COUNT_DEFAULT_ENV = ENV_VARS.SCAN_TREE_COUNT_DEFAULT || '10000'

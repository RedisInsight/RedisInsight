...
export enum TelemetryEvent {
  ...
  RDI_CONFIG_BASELINE_CAPTURED = 'RDI_CONFIG_BASELINE_CAPTURED',
  RDI_CONFIG_BASELINE_CLEARED = 'RDI_CONFIG_BASELINE_CLEARED',
  RDI_CONFIG_DIFF_MODE_ENABLED = 'RDI_CONFIG_DIFF_MODE_ENABLED',

...
export enum TelemetryEvent {
  ...
  WORKBENCH_ENABLEMENT_AREA_IMPORT_SUCCEEDED = 'WORKBENCH_ENABLEMENT_AREA_IMPORT_SUCCEEDED',
  WORKBENCH_ENABLEMENT_AREA_IMPORT_FAILED = 'WORKBENCH_ENABLEMENT_AREA_IMPORT_FAILED',

...
export enum TelemetryEvent {
  ...
  BROWSER_KEY_INFO_VIEWED = 'BROWSER_KEY_INFO_VIEWED',
  ...
  TREE_VIEW_KEY_INFO_VIEWED = 'TREE_VIEW_KEY_INFO_VIEWED',
  ...
  STREAM_CONSUMER_MESSAGE_ACK_CANCELED = 'STREAM_CONSUMER_MESSAGE_ACK_CANCELED',

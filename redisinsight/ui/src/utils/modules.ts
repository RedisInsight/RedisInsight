...
export const sortModules = (modules: IDatabaseModule[] = []) =>
  modules.sort((a, b) => {
    ...
    return (
      PREDEFINED_MODULES_ORDER.indexOf(a.moduleName) -
      PREDEFINED_MODULES_ORDER.indexOf(b.moduleName)
    )
  })
...
export const sortModulesByName = (modules: AdditionalRedisModule[] = []) =>
  [...modules].sort((a, b) => {
    ...
    return (
      PREDEFINED_MODULE_NAMES_ORDER.indexOf(a.name) -
      PREDEFINED_MODULE_NAMES_ORDER.indexOf(b.name)
    )
  })

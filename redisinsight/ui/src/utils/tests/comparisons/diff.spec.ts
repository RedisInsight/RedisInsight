...
const getFormUpdatesTests: any[] = [
  ...
  [
    { name: 'name', sshOptions: { password: 123, name: 'custom' }, nested: { plain: '1', obj2: { plain1: 2, plain2: '2' } } },
    { name: 'name1', sshOptions: { password: 123, name: 'custom' }, nested: { plain: '2', obj2: { plain1: 2, plain2: '3' } } },
...
describe('getFormUpdates', () => {
  it.each(getFormUpdatesTests)('for input: %s (obj), %s (previous), should be output: %s',

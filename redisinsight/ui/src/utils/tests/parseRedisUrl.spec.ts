...
const parseRedisUrlTests: Array<[string, any]> = [
  ...
  ['rediss://d&@&21^$:pa%@7:12:ss@local-host-123.net.com:6380', { ...defaultRedisParams, protocol: 'rediss', username: 'd&@&21^$', password: 'pa%@7:12:ss', host: 'local-host-123.net.com', port: 6380 }],

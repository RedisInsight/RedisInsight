...
test('Verify that user can see key details selected when he returns back to Browser page', async t => {
...
test('Verify that user can see list of keys viewed on Browser page when he returns back to Browser page', async t => {
